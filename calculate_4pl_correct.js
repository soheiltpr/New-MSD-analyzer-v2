// Calculate 4PL parameters with CORRECT equation
...
// CORRECTED 4PL equation for increasing curves
function msd_y4pl_logx(params, xlog) {
  const {A, D, Clog, B} = params;
  const t = Math.pow(10, (Clog - xlog));  // FIXED: Clog - xlog (not xlog - Clog)
...
console.log('4PL PARAMETERS TABLE (CORRECTED EQUATION)');
console.log('='.repeat(100));
console.log('');
